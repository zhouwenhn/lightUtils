...
import com.chowen.cn.library.db.ORM.annotation.AutoIncrementPrimaryKey;
import com.chowen.cn.library.db.ORM.annotation.NoMapping;
import com.chowen.cn.library.db.ORM.annotation.PrimaryKey;
...
public class TableInfo {
    ...
    public void setColumns(Class<?> c) {
        ...
        for (Field field : fields) {
            ...
            NoMapping noMapping= field.getAnnotation(NoMapping.class);
            if (noMapping != null) {
                continue;
            }
